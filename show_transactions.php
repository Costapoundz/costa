    ...
    try {
        ...
        if (empty($transactions)) {
            ...
            echo "
                ...
                <a href='transactions.html' style='display: inline-block; margin-top: 20px; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;'>Go Back</a>
            </div>";
        }
    } catch (Exception $e) {
